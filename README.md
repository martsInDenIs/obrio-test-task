...
1. /google-auth - GET метод, щоб отримати url для oAuth авторизації
2. /googel-auth/code - GET метод, щоб обміняти отриманий код на токени авторизації.
3. /files/load - POST метод для завантаження списку посилань
4. /files/list - GET метод для отримання списку файлів з посиланнями
